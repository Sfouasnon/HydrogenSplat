...
HS="$ROOT/.venv/bin/hs"
HS_FAKE_REFINE_STOP=500 HS_FAKE_QUIET_TAIL=20 "$HS" -p "$P" train --brush "$ROOT/engine/tests/fakebin/brush" --total-train-iters 4000 --growth-stop-iter 3000 --export-every 1000 --no-caffeinate
"$HS" -p "$P" prune
