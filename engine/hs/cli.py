...
Stages: ingest, select, solve, train, move (alias paths), prune, render, views; operations
outside the chain: exposure, masks, archive, export, merge, grade. Each wraps one of
...
from .stages import archive, calibrate, cameras, export, exposure, grade, ingest, masks, merge, move, movepreview, phone, prune, render, replay, select, selftest, solve, tools, train, views
...
def build_parser():
    ...
    for mod in (ingest, select, solve, exposure, masks, train, archive, export, merge, move, prune, render, grade, views, cameras, movepreview, tools, calibrate, selftest, phone, replay):
        mod.add_parser(sub)
    seen = set()
