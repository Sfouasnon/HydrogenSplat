...
from .stages import archive, calibrate, cameras, exposure, grade, ingest, masks, merge, move, movepreview, phone, prune, render, replay, select, selftest, solve, stability, tools, train, views
...
def build_parser():
    ...
    for mod in (ingest, select, solve, exposure, masks, train, archive, merge, move, prune, render, grade, views, cameras, movepreview, stability, tools, calibrate, selftest, phone, replay):
        mod.add_parser(sub)
    seen = set()
